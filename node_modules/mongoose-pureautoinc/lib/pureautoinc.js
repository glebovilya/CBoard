module.exports = new (function () {
    ...
    this.plugin = function(schema, options) {
        ...
        options.update = (typeof options.update === 'boolean') ? options.update : true;
        ...
        schema.pre('save', function (next) {
            ...
            // Don't increment the auto inc field on updates
            // if this option is disabled
            if (!options.update && typeof doc[options.field] === 'number') {
                return next();
            }
